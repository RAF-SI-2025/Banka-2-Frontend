    ...
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Direktna kupoprodaja akcija izmedju korisnika iste banke — bez provizije berze
          </p>
        </div>
      </div>
      ...
      <Alert>
        <AlertDescription className="text-sm">
          <strong>Kako funkcionise:</strong> prodavac postavlja akcije na javni rezim preko Moj portfolio.
          Kupac pravi ponudu (kolicina, cena po akciji, premija i datum dospeca), prodavac prihvata ili salje
          kontraponudu. Po prihvatu se sklapa opcioni ugovor — kupac placa premiju i stice pravo da do
          settlementDate-a kupi akcije po dogovorenoj ceni.
        </AlertDescription>
      </Alert>
